...
|---|---|---|
| `publishAllToMavenLocal` | Publie chaque artefact `dev.cstories:*`, y compris le plugin Gradle, dans `mavenLocal()`. | Depuis le repository CStories, avant de l'utiliser dans un autre projet. |
