...
|---|---|---|
| `publishAllToMavenLocal` | Publishes every `dev.cstories:*` artifact, including the Gradle plugin, to `mavenLocal()`. | Run from the CStories repository, before using it in another project. |
